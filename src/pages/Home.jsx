...
const Home = () => {
  return (
    <div className="container-fluid m-3 animate__animated animate__fadeIn">
      <div className="row">
        ...
        <div className="col-sm-7 p-4 m-0 d-flex align-items-end justify-content-center">
          <img src={bannerBg} className="img-fluid animate__animated animate__bounce" alt="No banner load" />
        </div>
      </div>
    </div>
  );
